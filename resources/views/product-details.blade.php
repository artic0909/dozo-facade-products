...
<body class="antialiased selection:bg-black selection:text-white flex flex-col min-h-screen">
    ...
    <main class="max-w-[1340px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 flex-1 w-full">
        ...
        <!-- DETAILED TECHNICAL & ARCHITECTURAL HIGHLIGHTS TABS -->
        <section class="mt-14 sm:mt-20 border-t border-gray-200/80 pt-10 sm:pt-14">
            
            <div class="flex items-center gap-3 mb-8">
                <h2 class="text-xl sm:text-2xl font-extrabold text-[#0f172a] uppercase tracking-tight">
                    System Highlights & Architectural Features
                </h2>
                <span class="w-10 h-[2.5px] bg-[#3b82f6] inline-block"></span>
            </div>

            <!-- 3 Columns Architectural Benefit Cards -->
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                
                <div class="bg-white border border-gray-200/80 rounded-2xl p-6 shadow-2xs">
                    <div class="w-10 h-10 rounded-xl bg-sky-50 text-sky-600 flex items-center justify-center mb-4">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                        </svg>
                    </div>
                    <h3 class="text-base font-bold text-gray-900 mb-2">Automated Factory Fabrication</h3>
                    <p class="text-xs sm:text-[13px] text-gray-600 leading-relaxed">
                        Manufactured in our state-of-the-art facility using computer-controlled automatic cutting, milling, and corner-crimping machinery to guarantee sub-millimeter tolerances.
                    </p>
                </div>
                ...
                <div class="bg-white border border-gray-200/80 rounded-2xl p-6 shadow-2xs">
                    ...
                    <h3 class="text-base font-bold text-gray-900 mb-2">Sub-Frame Amended Installation</h3>
                    <p class="text-xs sm:text-[13px] text-gray-600 leading-relaxed">
                        Our specialized sub-frame system isolates the finished architectural frames from structural building settlement, ensuring flawless alignment and lifelong operation.
                    </p>
                </div>
                ...
                <div class="bg-white border border-gray-200/80 rounded-2xl p-6 shadow-2xs">
                    ...
                    <h3 class="text-base font-bold text-gray-900 mb-2">Annual Maintenance (AMC)</h3>
                    <p class="text-xs sm:text-[13px] text-gray-600 leading-relaxed">
                        Backed by complete after-sales support with available Annual Maintenance Contracts, certified hardware replacements, and factory-trained maintenance technicians.
                    </p>
                </div>
        ...
        <!-- ON-PAGE INQUIRY / CUSTOM QUOTE FORM -->
        <section class="mt-14 sm:mt-20 bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] rounded-2xl sm:rounded-3xl p-6 sm:p-10 lg:p-12 text-white shadow-xl">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                
                <div class="lg:col-span-5">
                    <span class="text-xs font-bold uppercase tracking-wider text-sky-400 mb-2 inline-block">Direct Inquiries</span>
                    <h2 class="text-2xl sm:text-3xl font-extrabold tracking-tight text-white mb-3 leading-snug">
                        Request a Technical Quote for {{ $product->name }}
                    </h2>
                    <p class="text-xs sm:text-sm text-gray-300 leading-relaxed mb-6 font-normal">
                        Submit your project specifications or architectural BOQ. Our engineering team will review your requirements and provide structural estimates within 24 hours.
                    </p>
                    <div class="space-y-2 text-xs text-gray-300">
                        <div class="flex items-center gap-2">
                            <svg class="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            <span>Wind load & structural glass calculation assistance</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <svg class="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            <span>Sub-frame amended shop drawing consultation</span>
                        </div>
                    </div>
                </div>

                <div class="lg:col-span-7 bg-white/10 backdrop-blur-md p-5 sm:p-7 rounded-2xl border border-white/15">
                    <form action="{{ route('quotes.store') }}" method="POST" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-xs font-bold uppercase tracking-wider text-gray-300 mb-1">Your Name *</label>
                                <input type="text" name="name" required placeholder="Architect / Builder Name" class="w-full bg-black/40 border border-white/20 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-gray-400 focus:outline-none focus:border-sky-400">
                            </div>
                            <div>
                                <label class="block text-xs font-bold uppercase tracking-wider text-gray-300 mb-1">Phone Number *</label>
                                <input type="tel" name="phone" required placeholder="+91 XXXXX XXXXX" class="w-full bg-black/40 border border-white/20 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-gray-400 focus:outline-none focus:border-sky-400">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="email" name="email" required placeholder="contact@domain.com" class="w-full bg-black/40 border border-white/20 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-gray-400 focus:outline-none focus:border-sky-400">
                            </div>
                            <div>
                                <label class="block text-xs font-bold uppercase tracking-wider text-gray-300 mb-1">Project Location</label>
                                <input type="text" name="location" placeholder="City, State" class="w-full bg-black/40 border border-white/20 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-gray-400 focus:outline-none focus:border-sky-400">
                            </div>
                        </div>

                        <div>
                            <label class="block text-xs font-bold uppercase tracking-wider text-gray-300 mb-1">Project Scope & Message</label>
                            <textarea name="message" rows="3" placeholder="Approximate sq ft, floor count, glass preferences, or special requirements..." class="w-full bg-black/40 border border-white/20 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-gray-400 focus:outline-none focus:border-sky-400"></textarea>
                        </div>

                        <button type="submit" class="w-full bg-sky-500 hover:bg-sky-400 text-black font-extrabold py-3.5 rounded-xl transition-all duration-200 text-xs sm:text-sm uppercase tracking-wider shadow-md hover:scale-[1.01] active:scale-[0.99]">
                            Submit Technical Quote Request &rarr;
                        </button>
                    </form>
                </div>
