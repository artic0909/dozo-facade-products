    ...
    <style>
        ...
        @media (min-width: 1024px) {
            ...
            .hero-building-bg img {
                ...
                -webkit-mask-image: linear-gradient(90deg, transparent 0%, rgba(0, 0, 0, 0.1) 8%, rgba(0, 0, 0, 0.6) 22%, black 42%);
                mask-image: linear-gradient(90deg, transparent 0%, rgba(0, 0, 0, 0.1) 8%, rgba(0, 0, 0, 0.6) 22%, black 42%);
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10 py-12 border-b border-gray-800/80">
                ...
                <div class="lg:col-span-3">
                    ...
                    <ul class="space-y-2.5 text-xs sm:text-[13px] text-gray-400">
                        ...
                        <li><a href="{{ route('facade.index') }}" class="hover:text-white transition-colors">Custom Architectural Metalwork</a></li>
                    </ul>
                </div>
